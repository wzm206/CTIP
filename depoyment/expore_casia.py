...
from utils import waypoint_normalize, load_model_para, to_numpy, com_msg_to_pil, transform_images
...
def main(config):
    ...
    image_curr_msg = rospy.Subscriber(
        config["casia"]["IMAGE_TOPIC"], CompressedImage, callback_obs, queue_size=1)
    carla_twist_pub = rospy.Publisher(config["casia"]["CONTROL_TOPIC"], Twist, queue_size=1)
    ...
    with torch.no_grad():
        ...
        batch_data["traj"] = waypoint.transpose(1, 2)
